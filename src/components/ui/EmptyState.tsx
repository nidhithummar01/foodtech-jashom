...
function EmptyState({ title, message, icon, actionLabel, onAction }: EmptyStateProps) {
  return (
    <div className="rounded-lg border border-emerald-100 bg-white p-6 text-center shadow-sm">
      {icon ? <div className="mb-3 flex justify-center text-emerald-700">{icon}</div> : null}
